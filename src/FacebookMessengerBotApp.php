...
use nguyenanhung\FacebookMessenger\SDK\Interfaces\FacebookMessengerBotAppInterface;
use nguyenanhung\FacebookMessenger\SDK\Messages\Message;

/**
 * Class FacebookMessengerBotApp
 *
 * @package   nguyenanhung\FacebookMessenger\SDK
 * @author    713uk13m <dev@nguyenanhung.com>
 * @copyright 713uk13m <dev@nguyenanhung.com>
 */
class FacebookMessengerBotApp implements FacebookMessengerBotAppInterface
{
    /**
     * Request type GET
     */
    ...
    /**
     * FacebookMessengerBotApp constructor.
     *
     * @param $token
     */
    ...
    public function debug($fb_id, $message)
    {
        ...
        $pages      = ceil($length / $max_length);
        for ($x = 0; $x < $pages; $x++) {
            $responses[] = $this->send(new Message($fb_id, substr(json_encode($message, JSON_UNESCAPED_SLASHES), $x * $max_length, $max_length), FALSE, "ISSUE_RESOLUTION", "REGULAR", "MESSAGE_TAG"));
        }
