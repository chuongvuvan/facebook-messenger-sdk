...
class StructuredMessage extends Message
{
     ...
     *
     * @param null   $recipient         - If No Recipient assume it's share_contents for element_share
     * @param        $type
     * @param        $data
     * @param array  $quick_replies
     * @param string $tag               - SHIPPING_UPDATE, RESERVATION_UPDATE, ISSUE_RESOLUTION
     *
     * @see https://developers.facebook.com/docs/messenger-platform/send-api-reference/tags
     *
    ...
    public function __construct(
        $recipient = NULL, $type, $data, $quick_replies = [], $tag = NULL, $notification_type = parent::NOTIFY_REGULAR,
